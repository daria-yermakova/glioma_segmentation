...
if __name__ == '__main__':
    ...
    with open('../configs/brats.yaml') as f:
    ...
    # Load Data
    train_set = BRATS('../../../../special-course/data/BRATS_full_slices', mode="train", subset=0.6, size=[img_size, img_size, 155])
    valid_set = BRATS('../../../../special-course/data/BRATS_full_slices', mode='val', subset=0.6, size=[img_size, img_size, 155])
