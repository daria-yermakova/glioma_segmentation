...
from src.dataloaders.brats_transformed import BRATS
...
def train(model, epochs, opt, train_loader, val_loader, training_run_name, device):
    ...
    if not os.path.exists(path):
        os.makedirs(path)
        os.makedirs(os.path.join(path, 'res-ruby-darkness-10/img'))
        os.makedirs(os.path.join(path, 'res-ruby-darkness-10/target'))
        os.makedirs(os.path.join(path, 'res-ruby-darkness-10/pred'))
